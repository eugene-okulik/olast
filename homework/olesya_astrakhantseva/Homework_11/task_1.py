class Book:
    ...
    def get_info_reserved(self):
        info = (f"Название: {self.book_title}, Автор: {self.author}, страниц: {self.number_of_pages}, "
...
math_book = SchoolBook("Алгебра", 7, "Алгебра 7-ой класс", "Geneva Brossky",
                       40, "978-7-2345-6789-4", True, True)

chemistry = SchoolBook("Химия", 10, "Химия 10-ый класс", "Pavel Potri",
                       50, "978-7-2345-6789-4", False, True)

physics = SchoolBook("Биология", 6, "Биология 6-ой класс", "Fedor Bonch",
