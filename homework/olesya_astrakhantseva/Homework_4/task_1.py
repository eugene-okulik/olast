...
my_dict['list'].pop(2)
print('3) Проверка, что значение "морковка" не существует в списке -', 'морковка' in my_dict['list'])
...
print('4) В словаре удален последний добавленный элемент -', my_dict['dict'].pop('i am a tuple 2'))
