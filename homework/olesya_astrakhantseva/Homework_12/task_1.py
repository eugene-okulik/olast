...
class Rose(Flower):
    def __init__(self, name, height, lifetime, price, need_water, color, petal_count, rose_type):
...
class Tulip(Flower):
    def __init__(self, name, height, lifetime, price, need_water, color, flower_shape, cup_color):
        super().__init__(name, height, lifetime, price, need_water, color)
...
class Sunflower(Flower):
    def __init__(self, name, height, lifetime, price, need_water, color, seed_size, sun_tracking_angle):
        super().__init__(name, height, lifetime, price, need_water, color)
...
class Buket:
    ...
    def find_flowers_by_lifetime(self, min_lifetime, max_lifetime):
        return [flower for flower in self.flowers if min_lifetime <= flower.lifetime <= max_lifetime]
